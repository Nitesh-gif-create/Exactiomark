...
const initialCandidates = [
    { id: 1, name: 'Rohan Kapoor', email: 'rohan.kapoor@gmail.com', role: 'Developer', dept: 'Engineering', project: 'Sprint Beta', appliedDate: 'Feb 10, 2026', status: 'Interview', experience: '4 years' },
    { id: 2, name: 'Anita Deshmukh', email: 'anita.d@gmail.com', role: 'QA Engineer', dept: 'Quality', project: 'Sprint Alpha', appliedDate: 'Feb 12, 2026', status: 'Screening', experience: '3 years' },
    { id: 3, name: 'Siddharth Rao', email: 'sid.rao@outlook.com', role: 'DevOps Engineer', dept: 'Operations', project: 'Sprint Gamma', appliedDate: 'Feb 8, 2026', status: 'Offer Sent', experience: '6 years' },
    { id: 4, name: 'Kavya Iyer', email: 'kavya.iyer@yahoo.com', role: 'Scrum Master', dept: 'Engineering', project: 'Sprint Delta', appliedDate: 'Feb 14, 2026', status: 'Interview', experience: '5 years' },
    { id: 5, name: 'Amit Tiwari', email: 'amit.t@hotmail.com', role: 'Developer', dept: 'Engineering', project: 'Sprint Beta', appliedDate: 'Feb 5, 2026', status: 'Hired', experience: '7 years' },
    { id: 6, name: 'Neha Gupta', email: 'neha.g@gmail.com', role: 'Project Manager', dept: 'Management', project: 'Sprint Alpha', appliedDate: 'Feb 16, 2026', status: 'Screening', experience: '8 years' },
    { id: 7, name: 'Varun Mehta', email: 'varun.m@gmail.com', role: 'HR Manager', dept: 'Human Resources', project: '—', appliedDate: 'Feb 11, 2026', status: 'Rejected', experience: '2 years' },
];
